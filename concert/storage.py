...
class DirectoryWalker(Walker):
    ...
    async def __ainit__(self, root: Optional[str] = None, dsetname: str = "frame_{:>06}.tif", writer: Type[TiffWriter] = TiffWriter, start_index: int = 0, bytes_per_file: int = 0, rights: str = "750", **kwargs) -> None:
        """
...
class RemoteDirectoryWalker(Walker):
    ...
    async def __ainit__(self, device: RemoteDirectoryWalkerTangoDevice, root: Optional[str] = None, dsetname: str = "frame_{:>06}.tif", wrt_cls: str = "TiffWriter", start_index: int = 0, bytes_per_file: int = 0, **kwargs) -> None:
        """
